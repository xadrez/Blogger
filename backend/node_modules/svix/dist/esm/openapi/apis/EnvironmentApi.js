...
export class EnvironmentApiRequestFactory extends BaseAPIRequestFactory {
    ...
    v1EnvironmentImport(environmentIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(environmentIn, "EnvironmentIn", ""), contentType);
    ...
    v1EnvironmentExportWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer.deserialize(ObjectSerializer.parse(yield response.body.text(), contentType), "EnvironmentOut", "");
