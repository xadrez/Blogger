...
export class BroadcastApiRequestFactory extends BaseAPIRequestFactory {
    createBroadcastMessage(messageBroadcastIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(messageBroadcastIn, "MessageBroadcastIn", ""), contentType);
    ...
    createBroadcastMessageWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isCodeInRange("202", response.httpStatusCode)) {
                const body = ObjectSerializer.deserialize(ObjectSerializer.parse(yield response.body.text(), contentType), "MessageBroadcastOut", "");
