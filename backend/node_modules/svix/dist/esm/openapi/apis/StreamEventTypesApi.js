...
export class StreamEventTypesApiRequestFactory extends BaseAPIRequestFactory {
    v1StreamEventTypeCreate(streamEventTypeIn, idempotencyKey, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(streamEventTypeIn, "StreamEventTypeIn", ""), contentType);
    ...
    v1StreamEventTypePatch(name, streamEventTypePatch, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer.stringify(ObjectSerializer.serialize(streamEventTypePatch, "StreamEventTypePatch", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["HTTPBearer"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
export class StreamEventTypesApiResponseProcessor {
    v1StreamEventTypeCreateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isCodeInRange("201", response.httpStatusCode)) {
                const body = ObjectSerializer.deserialize(ObjectSerializer.parse(yield response.body.text(), contentType), "StreamEventTypeOut", "");
    ...
    v1StreamEventTypeListWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer.deserialize(ObjectSerializer.parse(yield response.body.text(), contentType), "ListResponseStreamEventTypeOut", "");
                return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if (isCodeInRange("400", response.httpStatusCode)) {
                const body = ObjectSerializer.deserialize(ObjectSerializer.parse(yield response.body.text(), contentType), "HttpErrorOut", "");
