...
export class ObservableAuthenticationApi {
    ...
    v1AuthenticationCreateMessageToken(appId, createTokenIn, idempotencyKey, _options) {
        return this.v1AuthenticationCreateMessageTokenWithHttpInfo(appId, createTokenIn, idempotencyKey, _options).pipe(map((apiResponse) => apiResponse.data));
    }
...
export class ObservableMessageApi {
    ...
    v1EventsPublicWithHttpInfo(appId, sinkId, limit, iterator, eventType, channel, after, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.v1EventsPublicWithHttpInfo(rsp)));
        }));
    }
    v1EventsPublic(appId, sinkId, limit, iterator, eventType, channel, after, _options) {
        return this.v1EventsPublicWithHttpInfo(appId, sinkId, limit, iterator, eventType, channel, after, _options).pipe(map((apiResponse) => apiResponse.data));
    }
